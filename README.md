...
Ethereum event notification service.
...
```
{
  "id": "https://github.com/kleros/eventlog#POST-Request",
...
```
{
  "id": "https://github.com/kleros/tromazo#POST-Response",
  "$schema": "http://json-schema.org/draft-06/schema#",
